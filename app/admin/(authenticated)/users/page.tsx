...
export default async function AdminUsersPage() {
  ...
  return (
    <>
      ...
      <section className="mb-8 rounded-card-lg border border-line bg-white p-6 shadow-soft">
        <h2 className="mb-4 text-base font-bold text-ink">Pozvat uživatele</h2>
        <InviteForm />
      </section>

      <section className="overflow-hidden rounded-card-lg border border-line bg-white shadow-soft">
